...
```
Replace `streamlit_app.py` with the filename of your script if different.
...
- **app1.py**: Agent initialization and suggestion logic.
- **tools1.py**: Custom tools for property search and calculations.
- **prompt1.py**: Prompt templates for structured outputs.
- **config.py**: Configuration (e.g., API keys).
- **requirements.txt**: Project dependencies.
- **faiss_index_all/:** FAISS vector store directory.
